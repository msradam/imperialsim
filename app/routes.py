...
dataset = [{
  ...
  'year': 2072,
  'description': '1822: Independence of Brazil proclaimed by Dom Pedro I',
  'countries': ['BR'],
  'sentiment': '#2F9599 '
}, {
  'year': 2616,
...
def index():
    ...
    return render_template('index.html', title='Home', cnmap = cnmap, dataset=dataset,form=form)
